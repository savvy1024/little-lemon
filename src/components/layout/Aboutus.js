        ...
        <section id="about-us">
            <Container>
                <div className="who-we-are-content">
                    <p className="lead-text"> Little Lemon is a charming neighbourhood bistro that serves simple food and classic cocktails in a lively but casual environment. The restaurant
